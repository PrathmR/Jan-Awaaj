...
export const translations = {
  en: {
    ...
    whoShouldReceive: "Who should receive this complaint?",
    target_Government: "Government",
    target_NGO: "NGO Support",
    target_Both: "Both",
    summarizeBtn: "Summarize >",
    editOriginal: "Edit original",
    aiSummary: "AI Summary",
    ngoSelectorLabel: "Select NGO partner:",
    tab_Home: "Home",
    tab_File: "File",
    tab_Track: "Track",
    tab_Orgs: "Orgs",
  ...
  hi: {
    ...
    category_Other: "अन्य",
    whoShouldReceive: "शिकायत किसे मिलनी चाहिए?",
    target_Government: "सरकार",
    target_NGO: "एनजीओ सहायता",
    target_Both: "दोनों",
    summarizeBtn: "सारांश >",
    editOriginal: "मूल संपादित करें",
    aiSummary: "एआई सारांश",
    ngoSelectorLabel: "एनजीओ पार्टनर चुनें:",
    tab_Home: "होम",
    tab_File: "दर्ज करें",
    tab_Track: "ट्रैक",
    tab_Orgs: "एनजीओ",
  ...
  mr: {
    ...
    category_Sanitation: "स्वच्छता",
    category_Other: "इतर",
    whoShouldReceive: "ही तक्रार कोणाला मिळायला हवी?",
    target_Government: "सरकार",
    target_NGO: "एनजीओ मदत",
    target_Both: "दोन्ही",
    summarizeBtn: "सारांश >",
    editOriginal: "मूळ संपादित करा",
    aiSummary: "एआय सारांश",
    ngoSelectorLabel: "एनजीओ पार्टनर निवडा:",
    tab_Home: "मुख्य",
    tab_File: "नोंदवा",
    tab_Track: "ट्रॅक",
    tab_Orgs: "एनजीओ",
  ...
  kn: {
    ...
    category_Other: "ಇತರ",
    whoShouldReceive: "ಈ ದೂರು ಯಾರಿಗೆ ತಲುಪಬೇಕು?",
    target_Government: "ಸರ್ಕಾರ",
    target_NGO: "ಎನ್ ಜಿ ಒ ಸಹಾಯ",
    target_Both: "ಎರಡೂ",
    summarizeBtn: "ಸಾರಾಂಶ >",
    editOriginal: "ಮೂಲವನ್ನು ಸಂಪಾದಿಸಿ",
    aiSummary: "ಎಐ ಸಾರಾಂಶ",
    ngoSelectorLabel: "ಎನ್ ಜಿ ಒ ಪಾಲುದಾರರನ್ನು ಆಯ್ಕೆಮಾಡಿ:",
    tab_Home: "ಮುಖಪುಟ",
    tab_File: "ದಾಖಲಿಸಿ",
    tab_Track: "ಟ್ರ್ಯಾಕ್",
    tab_Orgs: "ಸಂಸ್ಥೆಗಳು",
